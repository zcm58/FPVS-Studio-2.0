...
Modular-task font selection is an additive field in the existing schema `1.2.0`
task/session contract: missing values resolve to Arial, and the selection never enters
the `RunSpec` timed-frame contract.
