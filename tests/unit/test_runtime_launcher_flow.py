...
def test_launch_session_runs_all_entries_with_stub_engine_and_reuses_session_window(
    ...
    assert summary.output_dir == f"runs/P{PARTICIPANT_NUMBER}_session01"
    assert summary.participant_number == PARTICIPANT_NUMBER
    assert all(
...
def test_launch_session_reuses_participant_number_with_incremented_output_labels(
    ...
    assert summary_1.output_dir == f"runs/P{PARTICIPANT_NUMBER}_session01"
    assert summary_2.output_dir == f"runs/P{PARTICIPANT_NUMBER}_session02"
    assert summary_3.output_dir == f"runs/P{PARTICIPANT_NUMBER}_session03"
