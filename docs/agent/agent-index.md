...
| `library` | Private whole-experiment catalog, enrollment, secure credentials, downloads, and clean publishing | `src/fpvs_studio/library/AGENTS.md`, `docs/EXPERIMENT_LIBRARY.md`, and the active private-library plan |
