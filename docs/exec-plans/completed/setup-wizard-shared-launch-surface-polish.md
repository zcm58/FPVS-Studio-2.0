...
- [x] Step 2: Adjust Project sizing so the full page fits inside the compact
  setup frame with the shared normal-step width.
...
- [x] Step 5: Fix Experiment vertical clipping and spacing.
- [x] Step 6: Fix Fixation vertical clipping and make the section more compact.
- [x] Step 7: Widen Response content horizontally while preserving current controls.
- [x] Step 8: Adjust Review spacing so the decision card fits cleanly.
...
- Use focused GUI tests and a manual `1120x720` smoke pass after each substantial
  layout slice.
...
- Manual smoke: open Setup at `1120x720`, visit all six steps, confirm no clipping,
