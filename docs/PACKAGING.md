...
For the current release package, use the PEP 440-compatible package version `2.1.0`.
...
The [v2.1.0 release record](exec-plans/completed/masking-visible-catches.md) records the published
installer, direct 2.0.0 patch, payload audits and verification boundaries.
