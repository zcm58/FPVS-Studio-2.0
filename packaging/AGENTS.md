...
- If adding an app icon, prefer `packaging/assets/fpvs-studio.ico`, wire it through the
  PyInstaller spec, and update GUI application-window icon loading in the same change.
...
- Do not turn packaging scripts into release automation without updating
